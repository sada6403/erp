    ...
    <div className="flex flex-col h-full overflow-hidden">
      ...
      <div className="flex-1 overflow-auto p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <button onClick={() => navigate('/admin/smart-buy-transfers')} className="rounded-xl border p-4 text-left transition-colors hover:border-[var(--brand-primary)]" style={{ background: Number(data.pending_payments) > 0 ? 'color-mix(in srgb, #f59e0b 10%, transparent)' : 'var(--bg-card)', borderColor: Number(data.pending_payments) > 0 ? '#f59e0b' : 'var(--border)' }}>
